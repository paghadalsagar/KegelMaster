...
/**
 Set native ad delegate to get callbacks
 @note Objective-C
 <pre> [Appodeal setNativeAdDelegate:self]; </pre>
 @note Swift
 <pre> Appodeal.setNativeAdDelegate(self) </pre>
 @warning Use method before or after initialization!
 @param nativeAdDelegate Object that implements AppodealNonSkippableVideoDelegate protocol
 */
+ (void)setNativeAdDelegate:(nullable id<AppodealNativeAdDelegate>)nativeAdDelegate __deprecated_msg("This method is deprecated and will be removed in next release");;
/**
